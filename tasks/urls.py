...
from tasks.views import dashboard,manager_dashboard,employee_dashboard,create_task,view_task,update_task,delete_task,task_details,CreateTask,UpdateTask
urlpatterns = [
